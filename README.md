...
- **OMO Republic**: Deliberative same-role multi-agent workflow with `/deliberate`, `/republic-status`, `.git/omo/republic/ledger.jsonl`, and a Commons log for agent-to-agent questions, objections, revisions, and consensus
