...
describe("republic dashboard", () => {
  ...
  test("writes a static html dashboard under git common dir without dirtying the worktree", () => {
    ...
    expect(html).toContain("Seat Communication Map")
    expect(html).toContain("communication-map")
    expect(html).toContain("data-comm-seat-id")
    expect(html).toContain("data-relation-key")
    expect(html).toContain("buildCommunicationRelations")
    expect(html).toContain("drawCommunicationEdges")
    expect(html).toContain("selectedRelationKey")
    expect(html).toContain("Selected Relationship")
    ...
    expect(html).toContain("summary-action")
    expect(html).toContain("runtimeLabels")
    expect(html).toContain("enumLabel")
    expect(html).toContain("decisionReasonLabel")
