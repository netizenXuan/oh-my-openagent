...
export function formatRepublicStatusReport(report: RepublicStatusReport): string {
  ...
  return [
    ...
    `Workgroups: ${formatCounter(republic.workgroups)}`,
    `Modules: ${formatCounter(republic.modules)}`,
    `Tasks: ${formatList(republic.tasks)}`,
    ...
    `Workgroups: ${formatCounter(commons.workgroups)}`,
    `Modules: ${formatCounter(commons.modules)}`,
    `Tasks: ${formatList(commons.tasks)}`,
